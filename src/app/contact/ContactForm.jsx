    ...
    <section className="text-black mt-10 mx-auto max-w-4xl pt-12 pb-20 px-6">
      ...
      <div className="mt-10 flex flex-col items-center">
        ...
        <div className="text-4xl flex gap-2 mt-2">
          <a href="https://github.com/rohitshah316" target="_blank" rel="noreferrer" className="hover:text-gray-400">
            <FaGithub />
          </a>
          <a href="https://linkedin.com/in/rohitshah316" target="_blank" rel="noreferrer" className="hover:text-gray-400">
            <FaLinkedin />
          </a>
          <a href="mailto:contact.rohitshah.dev@gmail.com" className="hover:text-gray-400">
            <MdEmail />
          </a>
        </div>
      </div>

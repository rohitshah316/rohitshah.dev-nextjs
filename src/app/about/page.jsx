...
const About = () => {
  ...
  return (
    ...
    <section className={`m-10text-black max-w-4xl mx-auto px-6 pt-12 pb-20`}>
      ...
      <div className={`bg-gray-200 text-black rounded-2xl p-10 transform hover:-translate-y-2 ring ring-cyan-600`}>
      ...
      <div className={`'bg-blue-100 px-10 pt-10 pb-4  rounded-2xl transform hover:-translate-y-2 ring ring-cyan-600`}>
